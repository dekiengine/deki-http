...
Notable changes to `deki-http`. Engine and editor changes are in the
...
### Changed
- **Moved into the `DekiHttp` namespace.** Every component was declared at global
  ...
  Code naming these types needs the namespace: `using namespace DekiHttp;` or a
  qualified name.
